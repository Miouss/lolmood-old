...
function ChampSums(props){
    let summonersMP = initializeTree(props.summoners["mostPlayed"][0], "summoners", 2, getSummonerImg);
    let summonersMW = initializeTree(props.summoners["mostWinrate"][0], "summoners", 2, getSummonerImg);
        ...
        <div id="sums-frame">
            ...
            <div id="sums-imgs-container">
                <div className="sums-single-img-container">
                    <img src={summonersMP["summoners"][0]["img"]} alt="slt" />
                    <span>{summonersMP["rate"]}%</span>
                </div>
                <div className="sums-single-img-container">
                    <img src={summonersMP["summoners"][1]["img"]} alt="slt" />
                    <span>{summonersMP["rate"]}%</span>
                </div>
            </div>
        </div>
