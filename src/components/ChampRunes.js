import { getRuneImg, getStyleName, statsModImgs, initializeTree } from "./runesImg";
...
function ChampRunes(props) {
    ...
    let statsModsMW = initializeTree(props.statsMods["mostWinrate"][0], "statsMods", 3, statsModImgs, true);
    let statsModsMP = initializeTree(props.statsMods["mostPlayed"][0], "statsMods", 3, statsModImgs, true);
