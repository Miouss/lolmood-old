...
function ChampItems(props){
    let startItemsMP = initializeTree(props.startItems["mostPlayed"][0], "startItems", props.startItems["mostPlayed"][0]["startItems"].length, getItemImg);
    let startItemsMW = initializeTree(props.startItems["mostWinrate"][0], "startItems", props.startItems["mostWinrate"][0]["startItems"].length, getItemImg);

    let coreItemsMP = initializeTree(props.completedItems["coreItems"]["mostPlayed"][0], "coreItems", props.completedItems["coreItems"]["mostPlayed"][0]["coreItems"].length, getItemImg);
    let coreItemsMW = initializeTree(props.completedItems["coreItems"]["mostWinrate"][0], "coreItems", props.completedItems["coreItems"]["mostWinrate"][0]["coreItems"].length, getItemImg);
    ...
    let startItems, coreItems, fourthItems, fifthItems, sixthItems, rate = undefined;
