...
function Header(props){
    ...
    useEffect(() =>{
        props.main.render(<>
            <MainPage data={data} setData={setData} lang={lang} setLang={setLang} main={props.main} />
        </>);
    ...
    if(data === null){
        ...
        return(<>
                ...
                <div id="language-select">
                    <div onClick={() => {setFrFlag("100%"); setEnFlag("50%"); setLang("fr")}}>
                        <img style={{width : frFlagWidth}} src={frenchFlag}/>
                    </div>

                    <div onClick={() => {setEnFlag("100%"); setFrFlag("50%"); setLang("en")}}>
